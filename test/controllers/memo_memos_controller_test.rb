...
class MemoMemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo_memo" do
    assert_difference('MemoMemo.count') do
      post memo_memos_url, params: { memo_memo: { content: @memo_memo.content, language: @memo_memo.language, title: @memo_memo.title } }
    end
  ...
  test "should update memo_memo" do
    patch memo_memo_url(@memo_memo), params: { memo_memo: { content: @memo_memo.content, language: @memo_memo.language, title: @memo_memo.title } }
